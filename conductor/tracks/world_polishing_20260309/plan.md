...
- [ ] Task: Define environmental "Interest Points" (e.g., butterflies, flowers) in `WorldScene.tsx`.
- [ ] Task: Implement dino "Discovery" behaviors—where the dino autonomously investigates Interest Points.
    - [ ] Write Tests: Verify interest point detection logic.
    - [ ] Implement: Update `useDinoBrainLoop.ts` with new behavior states.
- [ ] Task: Add reactive "Dino Reactions" (e.g., happy wiggles, curious tilts) based on proximity to Interest Points.
